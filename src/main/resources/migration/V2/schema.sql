...
CREATE TABLE db_items(
    id_item INT AUTO_INCREMENT PRIMARY KEY NOT NULL UNIQUE,
    code_item INT NOT NULL,          -- Nº do patrimônio UFU
    obsrvation_item varchar(255),     -- Observações do item
    path_image_item varchar(255),        -- Lista com as imagens e/ou fotos do patrimônio
    sde_item varchar(255),        -- Nº da SDE
    order_origin_item varchar(255),     -- N° do pedido de compra
    status_item enum ("Ativo","Pendente","Inativo","Baixa solciitada","PSM"), -- Situação do item
    ...
    nf_invoice_item varchar(255),    -- N° da Nota Fiscal (item nacional) ou Invoice (item importado)
    value_item decimal(10,2),     -- Preço de custo
